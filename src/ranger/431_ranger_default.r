...
dataset  <- fread("./labo/datasets/paquete_premium_202011.csv", stringsAsFactors= TRUE)   #donde entreno
...
setwd("C:\\Users\\oliva\\OneDrive\\Desktop\\DS\\Austral\\08 - Labo1\\labo\\exp\\HT4310\\")  #Establezco el Working Directory DEL EXPERIMENTO

#en este archivo quedan los resultados
klog        <- "HT431.txt"
